...
import MyCollectionComposeExtension from "../server/src/messageExtension/MyCollection";
import { TeamsActivityProcessor } from "botbuilder-teams";
import CollectMessageExtension from "../server/src/messageExtension/Collect";
